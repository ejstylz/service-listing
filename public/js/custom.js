...
$(document).on('click', '.dropdown-menu', function (e) {
    if ($(this).hasClass('messages_dropdown')) { e.stopPropagation(); }
});

// Stop Bootstrap Dropdown Clicking Propagation
$(document).on('click', '.dropdown-menu', function (e) {
    if ($(this).hasClass('balance-menu')) { e.stopPropagation(); }
});
...
$(document).ready(function () {
    ...
    $(".chat-widget-service-list-1 .list-group-item > a").on("click", function () {
